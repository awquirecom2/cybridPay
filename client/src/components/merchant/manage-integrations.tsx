...
export function ManageIntegrations() {
  ...
  const integrationStatus = {
    ...
    cybrid: {
      connected: cybridCredentials.organizationGuid && cybridCredentials.clientId,
  ...
  const handleToggleIntegration = (integration: 'transak' | 'cybrid', enabled: boolean) => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Configure your Transak and Cybrid integrations for crypto payment functionality
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Switch 
              checked={integrationEnabled.cybrid}
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Connected</span>
                {integrationStatus.cybrid.connected ? (
                  <Badge variant="default" className="text-xs">Yes</Badge>
                ) : (
                  <Badge variant="secondary" className="text-xs">No</Badge>
                )}
